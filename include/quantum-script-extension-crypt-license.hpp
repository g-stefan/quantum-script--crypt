...
#define QUANTUM_SCRIPT_EXTENSION_CRYPT_LICENSE_HPP
...
namespace Quantum {
	namespace Script {
		namespace Extension {
			namespace Crypt {
				namespace License {
					QUANTUM_SCRIPT_EXTENSION_CRYPT_EXPORT const char *content();
					QUANTUM_SCRIPT_EXTENSION_CRYPT_EXPORT const char *shortContent();
				};
			};
		};
	};
